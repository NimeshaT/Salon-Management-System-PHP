...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="col">
                                <div class="card" style="width: 15rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="services.php" class="btn btn-outline-warning d-flex justify-content-center">View More..</a>
                                    </div>
                                </div>
                            </div>
                            <?php
            ...
            <div class="container mx-auto " style="width: 70%">
                <div class="row mt-5">
                    ...
                    while ($ItemType = $ItemTypeRes->fetch_assoc()) {
                        ...
                        if($ItemTypeId==1){
                            echo '<a href="products.php" class="btn btn-warning mt-4">View More..</a>';
                        } else {
                            echo '<a href="clothes.php" class="btn btn-warning mt-4">View More..</a>';
                        }
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
        ...
        <div class="container mt-5">
            ...
            <h5 class="text-center">Your wedding planning journey starts here..</h5>
            <div class="card mb-3">
        ...
        <div class="container-fluid mt-5">
            ...
            <h5 class="text-center">Find latest reviews</h5>
            <div class="container-fluid mt-4">
                <div class="row">
                    <div class="col">
        ...
        <div class="container-fluid mt-5 contact">
            ...
            <div class="row mt-4 bg-warning">
                ...
                <div class="col">
                    ...
                    <hr>
                    <ul class="list-unstyled">
                        <li><a href="index.php" class="link-dark text-decoration-none">Home</a><br></li>
                        <li><a href="about.php" class="link-dark text-decoration-none" >About</a><br></li>
