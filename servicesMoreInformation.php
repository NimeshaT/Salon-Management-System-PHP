                                ...
                                <div class="col-4">
                                    <div class="card" style="width: 18rem;">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">Price: Rs.<?php echo $row['Charge'] ?>.00</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="card">
                                        ...
                                        <div class="card-footer">
                                            <form action="bookNowAlert.php?current=http://localhost/sms/servicesMoreInformation2.php?ServiceId=<?php echo $row['ServiceId']?>" method="post" >
