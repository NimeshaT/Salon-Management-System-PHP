...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-3">
            <h2 class="text-center mt-3"> - Jewelry -</h2>
            <div class="row">
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img src="images/rosegold.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Rose Gold Traditional Kandyan - Gold Casting</h5>
                ...
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img src="images/bluemodern.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Blue Modern Kandyan</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn btn-warning">View More..</a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img src="images/dullgold.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Dull Gold Traditional Kandyan</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn btn-warning">View More..</a>
                        </div>
                    </div>
                ...
                <div class="col mt-3">
                    <div class="card" style="width: 18rem;">
                        <img src="images/greenmodern.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Green Modern Kandyan</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                           <a href="#" class="btn btn-warning">View More..</a>
                        </div>
                    </div>
