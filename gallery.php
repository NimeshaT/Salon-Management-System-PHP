...
<!--                        <li class="nav-item ps-2">
        ...
        <div class="container mt-3">
            <h4 class="text-center mt-3"> - Gallery -</h4>
            <div class="row">
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img src="images/bfphoto1.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Hair Colouring</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img src="images/bfphoto2.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Layer Cut</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img src="images/bfphoto3.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Make Up</p>
                        </div>
                    </div>
                </div>
            </div>
