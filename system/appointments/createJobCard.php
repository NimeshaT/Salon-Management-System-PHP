                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            $db = dbConn();
                                            $curdate= date('y-m-d');
                                            $sql = "SELECT * FROM tbl_employees INNER JOIN tbl_employee_personal_care_services_type ON tbl_employees.EmployeeId=tbl_employee_personal_care_services_type.EmployeeId INNER JOIN tbl_attendance ON tbl_employees.EmployeeId=tbl_attendance.EmployeeId WHERE ServiceTypeId='$ServiceTypeId' AND tbl_attendance.WorkingStatusId='5' AND tbl_employees.WorkingStatusId='5' AND tbl_attendance.AttendanceDate='$curdate'";
                                            $result = $db->query($sql);
                                            ?>
