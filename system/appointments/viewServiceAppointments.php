...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Completed Service Appointments</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Completed Service Appointments</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            //check service id
                            if (!empty($s_Id)) {
                                $where .= "tbl_services_job_card.ServiceId='$s_Id' AND";
                            }
...
//            echo $where;
                        ...
                        $sql = "SELECT * FROM tbl_services_job_card INNER JOIN tbl_employees ON tbl_services_job_card.EmployeeId=tbl_employees.EmployeeId INNER JOIN tbl_personal_care_services ON tbl_services_job_card.ServiceId=tbl_personal_care_services.ServiceId INNER JOIN tbl_personal_care_services_duration ON tbl_services_job_card.ServiceDurationId=tbl_personal_care_services_duration.ServiceDurationId WHERE AppointmentTypeId='1' AND tbl_services_job_card.StatusId='3' $where";
                        $result = $db->query($sql);
                        ?>
