...
<li class="nav-item">
    ...
    <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
            <a href="<?php echo SITE_URL; ?>bridal/createAdditionalServices.php" class="nav-link">
                <i class="fas fa-circle nav-icon"></i>
                <p>Create additional services</p>
            </a>
        </li>
...
<li class="nav-item">
    ...
    <ul class="nav nav-treeview">
        <li class="nav-item">
            <a href="<?php echo SITE_URL; ?>review/create.php" class="nav-link">
                <i class="fas fa-circle nav-icon"></i>
                <p>Accept Reviews</p>
            </a>
        </li>
...
<li class="nav-item">
    ...
    <ul class="nav nav-treeview">
        <li class="nav-item">
            <a href="<?php echo SITE_URL; ?>reports/appointments.php" class="nav-link">
               <i class="fas fa-circle nav-icon"></i>
                <p>Appointments</p>
            </a>
        </li>
