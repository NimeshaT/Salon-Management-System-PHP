...
//            $StatusId = $row['StatusId'];
                                ...
                                <td>
                                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                                        ...
                                        <button type="button" id="action" name="action" value="update" class="btn btn-danger btn-sm" onclick="update(this)">Update</button><input type="text" id="StatusId" name="StatusId" value="<?php echo @$StatusId ?>">
                                    </form>
