...
//            echo $name;
            echo $invoice=array($jobCardNo=>array("JobCardNo"=>$jobCardNo,"CRegNo"=>$CRegNo,"EmployeeId"=>$EmployeeId,"ServiceId"=>$ServiceId,"AppointmentId"=>$AppointmentId,"Charge"=>$Charge,"CustomerId"=>$CustomerId));
...
//                                    $job=$row['JobCardNo']; 
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a class="btn btn-danger" href="createInvoice.php" role="button">Create Invoice (
                <?php
