                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="card" style="width: 18rem;">
                                <img src="images/face.jpg" class="card-img-top" alt="...">
                        ...
                        <div class="col-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p>A protein hair treatment will work to repair hair strands by attaching hydrolysed proteins to the hair cuticle and hardening the cuticle layer. If there are holes in the hair cuticle, protein treatment will patch up these gaps and place a barrier around the hair shaft to lessen future damage</p>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <img src="images/spa.jpg" class="img-thumbnail" alt="..." width="450px">
                        </div>
                        <div class="col-6">
                            <div class="card">
                                <div class="card-header bg-warning">
                                ...
                                <div class="card mt-3 mb-3 ms-1" style="width: 18rem;">
                                    <ul class="list-group list-group-flush">
