...
<!--                    email eka hariyatama giyada nedda balanne kohomada-->
                ...
                <div class="card-body">
                    <h5 class="card-title text-center">Your Registration No: <?php echo $_SESSION['CustRegNo']; ?></h5>
                    <h6 class="card-text text-center">Welcome to Salon Kanchana!!</h6>
                    <div class="text-center">
                        <?php
                    $current=$_GET['current'];
                    ?>
                        <a href="login.php?current=<?php echo $current;?>" class="btn btn-warning">Login</a>
                    </div>
                </div>
            </div>
        </div>
