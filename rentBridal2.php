...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-3">
            ...
            ?>
            <h2 class="text-center mt-3"> - <?php echo $row['ItemTypeName'];?> -</h2>
            <?php
                }
                }
            ?>
            <div class="row">
                ...
                $sql = "SELECT * FROM tbl_items LEFT JOIN tbl_items_type ON tbl_items.ItemTypeId=tbl_items_type.ItemTypeId WHERE tbl_items.ItemTypeId='$ItemTypeId'";
                $result = $db->query($sql);
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ?>
                ...
                <!--                <div class="col">
                                    <div class="card" style="width: 18rem;">
                                        <img src="images/sunshinegown.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
                                            <h5 class="card-title">Sunshine Ball Gown</h5>
                ...
                <!--                <div class="col">
                                    <div class="card" style="width: 18rem;">
                                        <img src="images/tulipgown.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
                                            <h5 class="card-title">Tulip Ball Gown</h5>
                                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                            <a href="#" class="btn btn-warning">View More..</a>
                                        </div>
                                    </div>
                ...
                <!--                <div class="col mt-3">
                                    <div class="card" style="width: 18rem;">
                                        <img src="images/ruddyGown.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
                                            <h5 class="card-title">Ruddy Ball Gown</h5>
                                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                           <a href="#" class="btn btn-warning">View More..</a>
                                        </div>
                                    </div>
