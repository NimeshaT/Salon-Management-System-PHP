        ...
        <div class="container-fluid mt-5" >
            ...
            <div class="container-fluid mt-5">
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <img src="images/bridalfrocks.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h6 class="card-title text-center">Bridal Frocks</h6>
                                <a href="rentBridalFrocks.php" class="btn btn-outline-warning d-flex justify-content-center">View More..</a>
                            </div>
                        </div>
                    </div>
                    <div class="col">
