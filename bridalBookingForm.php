            ...
            <div class="card mx-auto" style="width: 60%">
                ...
                if ($_SERVER['REQUEST_METHOD'] == "POST" && @$action == "save") {
                    ...
                    if (empty($message)) {
                        ...
                        . "StartTime,"
                        . "ServiceDurationId,"
                        . "EndTime,BridalPackageId)VALUES("
                        . "'$CustomerId',"
                        . "'$RegNo',"
                        . "'$FirstName',"
                        . "'$LastName',"
                        ...
                        <div class="card " style="background-color: #FFD700">
                            <div class="card-header text-center">
                                ...
                                <a class="btn btn-warning btn-sm" href="#" role="button">View Appointments</a>
                            </div>
                        </div>
                        <?php
                    }
...
//                ===================cancel form details================
                ...
                <div class="card-header bg-warning">
                    Book your Bridal Package Consultation Appointment
                </div>
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                    <div class="card-body">
                        ...
                        <fieldset class="border border-2 p-2 bg-light">
                            <legend  class="float-none w-auto p-2 mb-0"><h5>Selected Package</h5></legend>
                            <p class="text-danger">Note: This is only for consultation and happy to announce that this is free for you..!</p>
                            <div class="mb-3 ms-2 mt-0">
                                <?PHP
                                $sql = "SELECT * FROM  tbl_appointments_type WHERE AppointmentTypeId='2'";
                                $result = $db->query($sql);
                                ?>
                                <div class="row">
                                    <?php
                                    ...
                                    <?php
                                    extract($_POST);
                                    $sql = "SELECT * FROM tbl_personal_care_services_type WHERE ServiceTypeId='44'";
                                    $result = $db->query($sql);
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ?>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <div class="mb-3 ms-2">
                                        ...
                                        <input type="hidden" class="form-control" id="BridalPackageId" name="BridalPackageId" value="<?php echo $row['BridalPackageId']; ?>">
                                    ...
                                    <div class="mb-3 ms-2">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" id="PackagePrice" name="PackagePrice" value="<?php echo $row['PackagePrice']; ?>" readonly>
                                            </div>
                                            <div class="col">
                                                <label for="DiscountRate" class="form-label">Discount</label>
                                                <input type="text" class="form-control" id="DiscountRate" name="DiscountRate" value="<?php echo $row['DiscountRate']; ?>" readonly>
                                            </div>
                                        </div>
                            ...
                            <div class="mb-3 ms-2 mt-0">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="Time" class="form-control" id="StartTime" name="StartTime" value="<?php echo @$StartTime ?>" min="09:00" max="18:00" required>
                                    ...
                                    <?php
                                    extract($_POST);
                                    $sql = "SELECT * FROM tbl_bridal_packages LEFT JOIN tbl_personal_care_services_duration ON tbl_bridal_packages.ServiceDurationId=tbl_personal_care_services_duration.ServiceDurationId WHERE BridalPackageId='$BridalPackageId'";
                                    $result = $db->query($sql);
                                    ?>
                                    <?php
                                    if ($result->num_rows > 0) {
