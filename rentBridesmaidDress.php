...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-3">
            <h2 class="text-center mt-3"> - Bridesmaid's Dress -</h2>
            <div class="row">
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img src="images/oneshoulderdress.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">One Shoulder Bridesmaid's Dress</h5>
                ...
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img src="images/lacedress.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Lace Bridesmaid's Dress</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn btn-warning">View More..</a>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img src="images/yellowmermaid.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Yellow Mermaid Bridesmaid's Dress</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn btn-warning">View More..</a>
                        </div>
                    </div>
                ...
                <div class="col mt-3">
                    <div class="card" style="width: 18rem;">
                        <img src="images/promdress.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Prom Dresses Bridesmaid's dress</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                           <a href="#" class="btn btn-warning">View More..</a>
                        </div>
                    </div>
